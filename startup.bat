...
reg query "HKU\S-1-5-19" > NUL 2>&1
	if %errorlevel% EQU 1 (Call :NoCompact "Start-Process '%0' -Verb Runas"&exit)
::Explorer kapatır
...
echo                ░░░░░
echo %R%[0m
echo %R%[31m Masaüstüne dosyalar ekleniyor...%R%[0m
dir /b %LCTN%\ExtractIT.zip > NUL 2>&1
	if %errorlevel% EQU 0 (Call :NoCompact "Expand-Archive -Force '%LCTN%\ExtractIT.zip' 'C:\Users\%username%\Desktop'")
DEL /F /Q /A "%LCTN%\ExtractIT.zip" > NUL 2>&1
echo %R%[90m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░%R%[0m
echo %R%[32m Sistem performans ayarları yapılıyor...%R%[0m
::POST-TWEAKS
...
::AnErrupTion/Make-Windows-10-Faster
...
echo %R%[90m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░%R%[0m
::Uygulama yükleme
echo %R%[90m• Open-Shell
echo %R%[90m• Mem Reduct
echo %R%[90m• 7-Zip
echo %R%[90m• IOBit Driver Booster
echo %R%[90m• All In One Runtimes
echo %R%[33m yükleniyor...%R%[0m
...
echo %R%[90m░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░%R%[0m
echo %R%[34m KURULUM TAMAMLANDI! %R%[0m
